function getDocuments(){
	shelf = apex.item('SRC_BOX_LIST').value;
	console.log('shelf',shelf);

	url = "f?p=&APP_ID.:23:&APP_SESSION.::::P23_BOX:box_param";
	url = url.replace("box_param",shelf);
	console.log(url);
...
function org_chart(mydata){
            ...
            function draw(){
                ...
                for (var i = 0 ; i < mydata.length; i++){
                    ...
                    if (r.type == "BOX"){
                       link = "<a class=box data-id="+r.id+" href=#>Files</a>";
                    }else{
                        link = "";
                    }
